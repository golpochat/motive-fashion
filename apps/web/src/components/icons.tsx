...
const paths = {
  ...
  whatsapp: (
    <>
      <path d="M12 3.8a8.2 8.2 0 0 0-7.1 12.3L4 20.2l4.2-1.1A8.2 8.2 0 1 0 12 3.8Z" />
      <path d="M8.6 9.1c.1-.3.4-.8.9-.8h.6c.2 0 .4.1.5.4l.8 1.9c.1.2 0 .5-.2.6l-.6.4a5 5 0 0 0 2.3 2.3l.4-.6c.2-.2.4-.3.6-.2l1.9.8c.3.1.4.3.4.5v.6c0 .5-.5.8-.8.9a5.7 5.7 0 0 1-6.2-1.6A5.7 5.7 0 0 1 8.6 9.1Z" />
    </>
  ),
  wishlist: (
